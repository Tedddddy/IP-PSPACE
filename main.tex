...
\begin{itemize}
  ...
  \item Example : $\phi = \forall x_1, ... , \forall x_m (x_1 \lor ... \lor x_m) \xrightarrow{arith \phi(x_1)} \phi_{arith}(x) = \prod_{x_2}^{} ...\prod{x_m} \, (x_1 +x_2+ ...+ x_m) \rightarrow deg(\phi_{arith}(x) \leq 2^{m-1}$ 
  \item 
\end{itemize}
\end{frame}
